<div x-data="{lang:'english'}" class="max-w-4xl mx-auto px-6 md:px-8 min-h-screen">
    ...
    <div class=" border-b border-gray-300 dark:border-opacity-20 py-16 mb-6">
        <div class="max-w-4xl mx-auto px-6  flex justify-between ">
            <h1 class="sm:text-4xl text-xl text-newgray-900 dark:text-newgray-300 font-semibold ">edit fact sheet</h1>
            <div class="z-30">
    ...
    <div x-show="lang==='english'" x-cloak style="display: none !important">
        <div class="w-full border border-gray-300 dark:border-opacity-20 rounded px-6 py-6 mb-6">
            <label class="block mb-4">
                ...
                <input type="text" wire:model='titleEN' placeholder="Fact sheet title (english)" class="bg-gray-100 dark:bg-newgray-700 text-newgray-700 dark:text-gray-300 rounded w-full border border-gray-300 dark:border-opacity-20 py-2 px-4 focus:outline-none">
            </label>
            <label class="block">
    ...
    <div x-show="lang==='indonesia'" x-cloak style="display: none !important">
        <div class="w-full border border-gray-300 dark:border-opacity-20 rounded px-6 py-6 mb-6">
            <label class="block mb-4">
                ...
                <input type="text" wire:model='titleID' placeholder="Judul fact sheet (indonesia)" class="bg-gray-100 dark:bg-newgray-700 text-newgray-700 dark:text-gray-300 rounded w-full border border-gray-300 dark:border-opacity-20 py-2 px-4 focus:outline-none">
            </label>
            <label class="block">
    ...
    <label class="w-full mb-6 block">
        <span class="block text-sm font-semibold text-newgray-900 dark:text-gray-300 mb-2">Link</span>
